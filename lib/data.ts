  const dummyData = {
    ...
    customizations: [
        // Toppings
        { name: "Extra Cheese", price: 25, type: "tapping" },
        { name: "Jalapeños", price: 20, type: "tapping" },
        { name: "Onions", price: 10, type: "tapping" },
        { name: "Olives", price: 15, type: "tapping" },
        { name: "Mushrooms", price: 18, type: "tapping" },
        { name: "Tomatoes", price: 10, type: "tapping" },
        { name: "Bacon", price: 30, type: "tapping" },
        { name: "Avocado", price: 35, type: "tapping" },
